...
export default function ContactPage() {
  return (
    <Container className="py-10">
      <h1 className="font-heading text-3xl font-semibold text-navy-900">Contact</h1>
      <p className="mt-2 max-w-2xl text-slate-600">
        Use this form for research-collaboration, technical, academic, or institutional pilot inquiries.
      </p>

      <div className="mt-3 space-y-2 rounded-xl2 border border-amber-500/40 bg-amber-500/10 p-4 text-sm text-slate-800">
